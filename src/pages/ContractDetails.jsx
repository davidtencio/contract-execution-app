            ...
            { showInjectionModal && (
                                    ...
                                    {showPeriodModal && createPortal(
                                        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                                            <div className="bg-white w-full max-w-md rounded-2xl border border-gray-200 shadow-2xl overflow-hidden text-gray-900 animate-in zoom-in-95 duration-200">
                                                <div className="p-6">
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="space-y-2">
                                                            ...
                                                            <select
                                                                className="w-full bg-white border border-gray-300 rounded-md h-10 px-3 text-black focus:ring-2 focus:ring-blue-500/20 outline-none transition-all"
